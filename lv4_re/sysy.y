...
%type <ast_val> Decl ConstDecl BType ConstDef ConstInitVal ConstExp BlockItem LVal VarDecl VarDef InitVal 
%type <vect_val> VBlockItem VConstDef VVarDef
%type <int_val> Number
